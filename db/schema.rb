...
ActiveRecord::Schema.define(:version => 20130929152149) do
  ...
  add_index "photo_taggings", ["photo_id", "user_id"], :name => "index_photo_taggings_on_photo_id_and_user_id", :unique => true
